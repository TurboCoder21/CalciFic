...
public class simpleCalculator implements ActionListener{
    ...
    simpleCalculator(){
        ...
        textfield.setFont(new Font("Agency Fb",Font.BOLD,30));
        ...
        for(int i =0;i<9;i++) {
            ...
            functionButtons[i].setFont(new Font("Agency Fb",Font.BOLD,30));
        ...
        for(int i =0;i<10;i++) {
            ...
            numberButtons[i].setFont(new Font("Agency Fb",Font.BOLD,30));
